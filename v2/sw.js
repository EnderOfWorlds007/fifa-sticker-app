const CACHE_NAME = "fifa-card-apps-fifa-sticker-app-v2-build-rsa6emptyfix3";
const CACHE_PREFIX = CACHE_NAME.replace(/build-[0-9a-f]{12}|build-rsa6emptyfix3$/, "");
const APP_SHELL = [
  "/fifa-sticker-app/v2/",
  ...
  "/fifa-sticker-app/v2/data/collection_catalog.json?v=build-a6d4f09c2e71",
  "/fifa-sticker-app/v2/data/collection_inventory.json?v=build-a6d4f09c2e71",
