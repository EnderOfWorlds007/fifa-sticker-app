...
} from "/fifa-sticker-app/v2/assets/backup_restore.js?v=build-b7e3d4f6a219";
...
import {
  ...
  loadCollectionState,
  saveCollectionState,
} from "/fifa-sticker-app/v2/assets/collection_state.js?v=build-b7e3d4f6a219";
import {
  buildInventoryProjection,
  loadInventoryProjection,
} from "/fifa-sticker-app/v2/assets/inventory_projection.js?v=build-b7e3d4f6a219";
