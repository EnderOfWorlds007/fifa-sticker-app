import { sortCode } from "/fifa-sticker-app/v2/assets/trade_state.js?v=build-960000000003";

export const COLLECTION_KEY = "panini.collectionTracker.v1";
export const COLLECTION_SNAPSHOT_URL = "/fifa-sticker-app/v2/data/collection_inventory.json?v=build-960000000003";
