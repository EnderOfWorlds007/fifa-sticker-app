...
| `01a0918b-86f2-7aa0-8fd9-2ee50ce9ec58` | SOL review: client error observability | Review privacy, failure semantics, UI impact, cache integration, and the current public V2 port of durable mobile OCR error diagnostics. | Complete; findings addressed | [`client-error-observability-review.md`](client-error-observability-review.md) |
