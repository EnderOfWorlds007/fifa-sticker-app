...
| `01a03da4-8a4c-78b2-9550-c93a891969a1` | SOL review: iOS capture timeout fix | Review the bounded native still-photo timeout, preview-frame fallback, lifecycle races, regression coverage, and cache refresh. | Complete | [`v2-ios-capture-timeout-review.md`](v2-ios-capture-timeout-review.md) |
